...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window._shardaSidebarAuthListener) {
                ...
                footer.innerHTML = `
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            ` : ''}
                            <a href="${baseUrl}index.html" class="btn btn-sm btn-outline-info rounded-pill w-100 mt-0 py-1 fw-bold" style="font-size: 0.75rem;">
        ...
        // 1. Listen for future updates
        document.addEventListener('sharda-auth-updated', (e) => updateSidebarAuth(e.detail.user));

        // 2. Check existing state immediately (Auth.js might have loaded first)
        ...
        setTimeout(() => clearInterval(checkExisting), 5000); // Stop after 5s
    }
});
