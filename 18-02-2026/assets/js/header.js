        ...
        if (data.user) {
            ...
            container.innerHTML = `
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark shadow border-secondary">
                        ...
                        ${data.user.role?.toLowerCase() === 'admin' ? `<li><a class="dropdown-item py-2 text-info fw-bold" href="${baseUrl}admin/dashboard.html"><i class="bi bi-speedometer2 me-2"></i>Admin Dashboard</a></li>` : ''}
            ...
            container.innerHTML = `
                <div class="auth-buttons d-flex gap-2">
                    <a href="${baseUrl}login.html" class="btn btn-outline-light btn-sm"><i class="bi bi-shield-lock me-1"></i>Login</a>
                    <a href="${baseUrl}signup.html" class="btn btn-info btn-sm"><i class="bi bi-person-plus me-1"></i>Sign Up</a>
                </div>
            `;
        }
    }
