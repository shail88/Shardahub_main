...
const ShardaPayments = {
    ...
    async initiateCheckout() {
        ...
        // Mock Razorpay Flow
        console.log("Initiating Razorpay for checkout...");

        for (const item of cart) {
            // Determine Product Type for DB Logic
            let productType = 'Shop';
            if (item.id.includes('ai-basic')) productType = 'AI_BASIC';
            else if (item.id.includes('ai-advance')) productType = 'AI_ADVANCE';
            else if (item.id.includes('saas-basic')) productType = 'SAAS_BASIC';
            else if (item.id.includes('saas-advance')) productType = 'SAAS_ADVANCE';
            else if (item.id.includes('game-basic')) productType = 'GAME_BASIC';
            else if (item.id.includes('game-advance')) productType = 'GAME_ADVANCE';
            else if (item.id === 'resume') productType = 'AI_PRO';
            else if (item.category === 'AI Tools') productType = 'AI_CREDITS';
            else if (item.category === 'SaaS Solutions') productType = 'SAAS';
        ...
        alert("Payment Successful! Your access/credits have been updated.");
        this.clearCart();
